...
#include "/root/p4/declaration.p4"

#define COLLECTION_TIMEDELTA 55000
#define STARTING_PAYLOAD_CHUNK_SIZE 1920
#define PAYLOAD_CHUNK_SIZE 2048
#define HASH_BASE 128w0
#define HASH_MAX 128w340282366920938463463374607431768211456
...
control MyIngress(inout headers hdr,
    ...
    apply {
        if (hdr.tcp.isValid()) {
            md5_hash_1024(hdr.payload.md5, hdr.payload.payload, hdr.payload.payload2, hdr.payload.payload3, hdr.payload.payload4);          
        }
        if (hdr.ipv4.isValid()) {
            ipv4_exact.apply();
        } 
