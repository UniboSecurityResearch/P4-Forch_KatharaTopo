...
control MyIngress(inout headers hdr,
    ...
    apply {
        ...
        if (hdr.tcp.isValid()) {
            hash(crc,     HashAlgorithm.crc16, HASH_BASE, {hdr.payload.payload, hdr.payload.payload2, hdr.payload.payload3, hdr.payload.payload4}, HASH_MAX);
            hdr.payload.crc16 = crc;
        }
