...
#define STARTING_PAYLOAD_CHUNK_SIZE 1984
#define PAYLOAD_CHUNK_SIZE 2048
#define HASH_BASE 64w0
#define HASH_MAX 64w18446744073709551615
...
control MyIngress(inout headers hdr,
    ...
    apply {
        ...
        if (hdr.tcp.isValid()) {
            hash(xxh64,     HashAlgorithm.crc32, HASH_BASE, {hdr.payload.payload, hdr.payload.payload2, hdr.payload.payload3, hdr.payload.payload4}, HASH_MAX);
